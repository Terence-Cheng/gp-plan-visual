...
import G6, {TreeGraph, ModelConfig, registerNode} from '@antv/g6';
// import ShapeAttrs from "@antv/g6"
import './index.css'
...
type textAlignKey = "left" | "start" | "center" | "end" | "right" | undefined
type textBaselineKey = "bottom" | "top" | "hanging" | "middle" | "alphabetic" | "ideographic" | undefined
            ...
            G6.registerNode(
                'flow-rect',
                {
                    ...
                    draw(cfg, group) {
                        ...
                        const textConfig = {
                            textAlign: 'left' as textAlignKey,
                            textBaseline: 'bottom' as textBaselineKey,
                        };
